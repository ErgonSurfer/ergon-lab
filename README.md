...
<p align="center">
  <img src="docs/assets/brand/ergon-lab-hero.jpg" width="100%" alt="An Ergon-shaped observatory opens onto a layered network landscape">
</p>

<h1 align="center">Ergon Lab</h1>

<p align="center">
  <strong>Community research and engineering hub for Ergon.</strong><br>
...
<table>
  <tr>
    <td width="50%" valign="top">
      <a href="discover/README.md"><img src="docs/assets/brand/discover-ergon.jpg" width="100%" alt="A bright topographic landscape forming the Ergon symbol"></a>
      <p><sub>01 · ORIENTATION</sub></p>
      <h3>Discover Ergon</h3>
      <p>Start with the forces Ergon is trying to align, then move from first principles to open questions.</p>
      <p><a href="discover/README.md"><strong>Open the field guide&nbsp;↗</strong></a></p>
    </td>
    <td width="50%" valign="top">
      <a href="insights/README.md"><img src="docs/assets/brand/insights-and-vision.jpg" width="100%" alt="Folded paper and metal forming an editorial Ergon composition"></a>
      <p><sub>02 · EDITORIAL</sub></p>
      <h3>Insights &amp; Vision</h3>
      <p>Essays, explainers, research notes, counterarguments, and long-form ideas—clearly labeled.</p>
      <p><a href="insights/README.md"><strong>Browse ideas and arguments&nbsp;↗</strong></a></p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <a href="network/README.md"><img src="docs/assets/brand/network-observatory.jpg" width="100%" alt="A distributed field of network nodes and propagation waves"></a>
      <p><sub>03 · OBSERVATION</sub></p>
      <h3>Network Observatory</h3>
      <p>Read the network through sourced signals, explicit methods, units, timestamps, and uncertainty.</p>
      <p><a href="network/README.md"><strong>Open the observatory&nbsp;↗</strong></a></p>
    </td>
    <td width="50%" valign="top">
...
<table>
  <tr>
    <td width="25%"><img src="docs/assets/brand/cards/network/existing-supply.jpg" width="100%" alt="Existing supply: awaiting source; method in review"></td>
    <td width="25%"><img src="docs/assets/brand/cards/network/inferred-hashrate.jpg" width="100%" alt="Inferred hashrate: awaiting model; uncertainty required"></td>
    <td width="25%"><img src="docs/assets/brand/cards/network/block-cadence.jpg" width="100%" alt="Block cadence: awaiting window; unit required"></td>
    <td width="25%"><img src="docs/assets/brand/cards/network/activity-proxy.jpg" width="100%" alt="Activity proxy: definition open; method not yet fixed"></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="33%"><img src="docs/assets/brand/cards/commitments/understand.jpg" width="100%" alt="Understand: learn without a prerequisite; follow the evidence"></td>
    <td width="33%"><img src="docs/assets/brand/cards/commitments/question.jpg" width="100%" alt="Question: research in public; sources, methods, and limits"></td>
    <td width="33%"><img src="docs/assets/brand/cards/commitments/build.jpg" width="100%" alt="Build: engineer independently; standalone consensus authority"></td>
  </tr>
</table>
...
<details>
<summary><strong>Standalone consensus boundary</strong></summary>
